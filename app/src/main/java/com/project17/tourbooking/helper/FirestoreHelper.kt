package com.project17.tourbooking.helper
...
object FirestoreHelper {
    ...
    fun getTicketDocumentId(tourId: String, callback: (String?) -> Unit) {
        ...
        db.collection("tickets")
            ...
            .addOnFailureListener { exception ->
                // Xử lý lỗi
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error getting ticket document ID", exception)
                callback(null)
            }
    }
    ...
    fun getBillDetailByBillId(billId: String, onComplete: (BillDetail?) -> Unit) {
        db.collection("billDetails")
            ...
            .addOnFailureListener { exception ->
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error getting bill detail: $exception")
                onComplete(null)
            }
    }
    ...
    fun getTourIdByTicketId(ticketId: String, onSuccess: (String?) -> Unit) {
        ...
        ticketsCollection
            ...
            .addOnFailureListener { exception ->
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error getting tourId by ticketId", exception)
                onSuccess(null)
            }
    }
    ...
    fun updateTourRating(tourId: String, newAverageRating: Double) {
        ...
        tourRef.update("averageRating", newAverageRating)
            .addOnSuccessListener {
                Log.d("com.project17.tourbooking.helper.FirestoreHelper", "Tour rating successfully updated!")
            }
            .addOnFailureListener { e ->
                Log.w("com.project17.tourbooking.helper.FirestoreHelper", "Error updating tour rating", e)
            }
    }
    ...
    fun getBillByTourId(tourId: String, callback: (Bill?) -> Unit) {
        ...
        billsRef.whereEqualTo("tourId", tourId).get().addOnSuccessListener { querySnapshot ->
            ...
            Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error fetching bill: ${exception.localizedMessage}")
            callback(null)
        }
    }
    ...
    suspend fun addBill(bill: Bill): String? {
        return try {
            ...
            Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error adding Bill: ${e.message}")
            null
        }
    }
    ...
    fun deleteBillDetailsByBillId(billId: String, callback: (Boolean, Exception?) -> Unit) {
        ...
        billDetailsRef.whereEqualTo("billId", billId).get().addOnSuccessListener { querySnapshot ->
            ...
            Tasks.whenAllComplete(deleteTasks).addOnSuccessListener {
                ...
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error deleting bill details: ${exception.localizedMessage}")
                callback(false, exception)
            }
        }.addOnFailureListener { exception ->
            Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error fetching bill details: ${exception.localizedMessage}")
            callback(false, exception)
        }
    }
    ...
    suspend fun getBillsByEmail(email: String, callback: (List<Bill>) -> Unit) {
        db.collection("bills")
            ...
            .addOnFailureListener { exception ->
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error fetching bills: ${exception.message}")
                callback(emptyList())
            }
    }
    ...
    suspend fun updateAccount(username: String, updatedAccount: Account) {
        try {
            Log.d("com.project17.tourbooking.helper.FirestoreHelper", "Attempting to update account with username: $username")
            ...
            if (querySnapshot.isEmpty) {
                Log.d("com.project17.tourbooking.helper.FirestoreHelper", "No account found with username: $username")
                return
            }
            ...
            Log.d("com.project17.tourbooking.helper.FirestoreHelper", "Successfully updated account with ID: $documentId")
        } catch (e: Exception) {
            Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error updating account with username: $username", e)
        }
    }
    ...
    suspend fun deleteAccount(email: String) {
        try {
            Log.d("com.project17.tourbooking.helper.FirestoreHelper", "Attempting to delete account with email: $email")

            // Query Firestore to find the document with the matching email
            val querySnapshot = accountsCollection.whereEqualTo("email", email).get().await()

            if (querySnapshot.isEmpty) {
                Log.d("com.project17.tourbooking.helper.FirestoreHelper", "No account found with email: $email")
                return
            }
            ...
            for (document in querySnapshot.documents) {
                ...
                Log.d("com.project17.tourbooking.helper.FirestoreHelper", "Successfully deleted account with ID: $documentId")
            }
        } catch (e: Exception) {
            Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error deleting account with email: $email", e)
        }
    }
    ...
    fun getCustomerByEmail(email: String, callback: (Customer?) -> Unit) {
        ...
        db.collection("customers")
            ...
            .addOnFailureListener { exception ->
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error getting documents: ", exception)
                callback(null)
            }
    }
    ...
    fun getAccountByEmail(email: String, callback: (Account?) -> Unit) {
        ...
        query.get()
            ...
            .addOnFailureListener { exception ->
                // Handle errors
                Log.e("com.project17.tourbooking.helper.FirestoreHelper", "Error fetching account by email", exception)
                callback(null)
            }
    }
